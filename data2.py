...
def dt2(data_path=data_path, Iter=config.Iter, input_dim=config.input_dim, noise_type=config.noise_type, outlier_type=config.outlier_type, outlier_rate=config.outlier_rate):
    ...
    output_train, output_train_noise = dt_outlier2(input=input_train, output_true=output_true_train, noise_real=noise_real_train, outlier_type=outlier_type)
    # Frozen
