...
def dtlo(data_path=data_path, Iter=config.Iter, input_dim=config.input_dim, noise_type=config.noise_type, outlier_type=config.outlier_type, outlier_rate=config.outlier_rate):
    data_path += '/lo'
    mkdir(data_path, exist_ok=True)
    data_path += '/'
    # data create > save as npz file
    input_train, output_true_train, input_test, output_true_test = dt_data2(Iter=Iter, input_dim=input_dim)
    ...
    output_train, output_train_noise = dt_outlierlo(input=input_train, output_true=output_true_train, noise_real=noise_real_train, outlier_type=outlier_type)
    # Frozen
...
def dthi(data_path=data_path, Iter=config.Iter, input_dim=config.input_dim, noise_type=config.noise_type, outlier_type=config.outlier_type, outlier_rate=config.outlier_rate):
    data_path += '/hi'
    mkdir(data_path, exist_ok=True)
    data_path += '/'
    # data create > save as npz file
    ...
    output_train, output_train_noise = dt_outlierhi(input=input_train, output_true=output_true_train, noise_real=noise_real_train, outlier_type=outlier_type)
    # Frozen
    # output_test = dt_outlier(input=input_test, output_true=output_true_test, noise_real=noise_real_test, outlier_type=outlier_type, outlier_rate=outlier_rate)               
    output_test = output_train
    output_test_noise = output_train_noise
...
def dthal(data_path=data_path, Iter=config.Iter, input_dim=config.input_dim, noise_type=config.noise_type, outlier_type=config.outlier_type, outlier_rate=config.outlier_rate):
    data_path += '/hal'
    mkdir(data_path, exist_ok=True)
    data_path += '/'
    # data create > save as npz file
    ...
    output_train, output_train_noise = dt_outlierhal(input=input_train, output_true=output_true_train, noise_real=noise_real_train, outlier_type=outlier_type)
    # Frozen
    # output_test = dt_outlier(input=input_test, output_true=output_true_test, noise_real=noise_real_test, outlier_type=outlier_type, outlier_rate=outlier_rate)               
    output_test = output_train
    output_test_noise = output_train_noise
